...
export const PalavrasPadroes : Palavras = {
  ...
  habilidadesTecnicasTexto: {ptBr: ''},
  frontEnd: {ptBr: "Frontend"},
  backEnd: {ptBr: "Backend"},
  database: {ptBr: "Bancos de dados", enUs: "Databases"},
  devops: {ptBr: "DevOps", enUs: "Tools & DevOps"},
  roleParaBaixo: {ptBr: "Role para baixo", enUs: "Scroll down"},
  frontEndDevelopment: {ptBr: "Desenvolvimento Frontend", enUs: "Frontend Development"},
  backEndDevelopment: {ptBr: "Desenvolvimento Backend", enUs: "Backend Development"},
  experienciaProfissionalTexto: {ptBr: "Experiência Profissional", enUs: "Professional Experience"},
  informacoesDeContato: {ptBr: "Informações de Contato", enUs: "Contact Information"},
